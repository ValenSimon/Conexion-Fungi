    ...
    >
      ...
      <div className="lg:flex gap-6 ">
        <div className="flex flex-col gap-2 lg:w-1/2">
          ...
          <input 
            ...
            className="bg-[#FFF9F3] border-1 border-[#FFC789] rounded-md px-2 py-1 outline-none focus:ring-1 focus:ring-[#F59F40] invalid:border-red-500" 
            type="text" 
            id="full-name" 
            required 
            minLength={3}
        ...
        <div className="flex flex-col gap-2 lg:w-1/2">
          ...
          <input 
            ...
            className="bg-[#FFF9F3] border-1 border-[#FFC789] rounded-md px-2 py-1 outline-none focus:ring-1 focus:ring-[#F59F40] invalid:border-red-500" 
            type="text" // Cambiado a text para usar pattern con mayor control
            id="phone" 
            required
            pattern="[0-9]{8,15}" // Solo números, entre 8 y 15 dígitos
      ...
      <div className="flex flex-col gap-2">
        ...
        <textarea 
          ...
          className="bg-[#FFF9F3] border-1 border-[#FFC789] rounded-md px-2 py-1 min-h-[100px] md:min-h-[150px] 2xl:min-h-[200px] outline-none focus:ring-1 focus:ring-[#F59F40]" 
          id="message" 
          required
          minLength={10}
        ></textarea>
